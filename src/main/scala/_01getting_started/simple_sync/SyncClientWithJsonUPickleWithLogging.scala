...
object SyncClientWithJsonUPickleWithLogging extends App {
  ...
  // define upickle implicits for serialization and deserialization
  // before we can use them in the request
